...
```bash
conda create -n globgm "python>=3.12,<3.14" "xarray>=2025.10" fsspec zarr dask requests aiohttp h5netcdf netcdf4 pydap
```
...
If you think you have enough computational resources at hand, you can download the data at the global scale. For this, we provide you with options to download the data using YODA's web-based access or from the [download links in the Data Catalogue](../data_catalogue/data_catalogue.qmd).
